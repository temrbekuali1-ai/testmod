...
public class ModFoods {
    ...
    public static final Consumable PIE_CONSUMABLE = Consumables.defaultFood()
            .onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.INSTANT_HEALTH,1,6, false, false, false)))
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL)).consumeSeconds(0.5f).build();
    ...
    public static final Consumable QUICHE_CONSUMABLE = Consumables.defaultFood()
            .onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.INSTANT_HEALTH,1,4, false, false, false)))
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL)).consumeSeconds(0.5f).build();
    ...
    public static final Consumable ASTROFOOD_CONSUMABLE = Consumables.defaultFood()
            .onConsume(new ApplyStatusEffectsConsumeEffect(java.util.List.of(
                    ...
                    new MobEffectInstance(MobEffects.JUMP_BOOST, 100, 1, false, false, false))))
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL)).consumeSeconds(0.5f).build();
    ...
    public static final Consumable BAD_MEMORY_CONSUMABLE = Consumables.defaultFood()
            .onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.INSTANT_DAMAGE,1,0, true, false, false)))
            .onConsume(new PlaySoundConsumeEffect(ModSounds.DAMAGE)).sound(SoundEvents.AMBIENT_CAVE).consumeSeconds(0.5f).build();
    ...
    public static final Consumable BISICLE_CONSUMABLE = Consumables.defaultFood()
            .onConsume(new ApplyStatusEffectsConsumeEffect(java.util.List.of(
                    new MobEffectInstance(MobEffects.INSTANT_HEALTH,1,3, false, false, false),
                    new MobEffectInstance(MobEffects.SPEED, 100, 0, false, false, false))))
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL)).consumeSeconds(0.5f).build();
    ...
    public static final Consumable CINNAMON_CONSUMABLE = Consumables.defaultFood()
            .onConsume(new ApplyStatusEffectsConsumeEffect(java.util.List.of(
                    new MobEffectInstance(MobEffects.INSTANT_HEALTH,1,3, false, false, false),
                    new MobEffectInstance(MobEffects.REGENERATION, 100, 1, false, false, false))))
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL)).consumeSeconds(0.5f).build();
    ...
    public static final Consumable CRABAP_CONSUMABLE = Consumables.defaultFood()
            .onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.INSTANT_HEALTH,1,3, false, false, false)))
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL)).consumeSeconds(0.5f).build();
    ...
    public static final Consumable DSALAD_CONSUMABLE = Consumables.defaultFood()
            .onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.INSTANT_HEALTH,1,7, false, false, false),0.1F))
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL)).consumeSeconds(0.5f).build();
    ...
    public static final Consumable HOT_CAT_CONSUMABLE = Consumables.defaultFood()
            .onConsume(new ApplyStatusEffectsConsumeEffect(java.util.List.of(
                    new MobEffectInstance(MobEffects.INSTANT_HEALTH,1,3, false, false, false),
                    new MobEffectInstance(MobEffects.REGENERATION, 200, 1, false, false, false))))
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL)).sound(SoundEvents.CAT_AMBIENT_BABY).consumeSeconds(0.5f).build();
    ...
    public static final Consumable HOT_DOG_CONSUMABLE = Consumables.defaultFood()
            ...
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL)).sound(SoundEvents.WOLF_AMBIENT_BABY).consumeSeconds(0.5f).build();
    ...
    public static final Consumable HUSH_PUPPY_CONSUMABLE = Consumables.defaultFood()
            .onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.INSTANT_HEALTH,1,5, false, false, false)))
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL)).sound(SoundEvents.WOLF_WHINE_BABY).consumeSeconds(0.5f).build();
    ...
    public static final Consumable INOODLES_CONSUMABLE = Consumables.defaultFood()
            ...
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL)).consumeSeconds(1.5f).build();
    ...
    public static final Consumable LAST_DREAM_CONSUMABLE = Consumables.defaultFood()
            ...
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL))
    ...
    public static final Consumable LEGHERO_CONSUMABLE = Consumables.defaultFood()
            .onConsume(new ApplyStatusEffectsConsumeEffect(java.util.List.of(
                    new MobEffectInstance(MobEffects.INSTANT_HEALTH,1,4, false, false, false),
                    new MobEffectInstance(MobEffects.STRENGTH, 500, 2, false, false, false))))
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL)).consumeSeconds(0.5f).build();
    ...
    public static final Consumable MCANDY_CONSUMABLE = Consumables.defaultFood()
            .onConsume(new ApplyStatusEffectsConsumeEffect(java.util.List.of(
                    new MobEffectInstance(MobEffects.INSTANT_HEALTH,1,2, false, false, false),
                    new MobEffectInstance(MobEffects.REGENERATION, 100, 0, false, false, false))))
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL)).consumeSeconds(0.5f).build();
    ...
    public static final Consumable PCHISPS_CONSUMABLE = Consumables.defaultFood()
            .onConsume(new ApplyStatusEffectsConsumeEffect(java.util.List.of(
                    new MobEffectInstance(MobEffects.INSTANT_HEALTH,1,3, false, false, false),
                    new MobEffectInstance(MobEffects.WEAKNESS, 100, 5, false, false, false))))
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL)).consumeSeconds(0.5f).build();
    ...
    public static final Consumable SEA_TEA_CONSUMABLE = Consumables.defaultFood()
            .onConsume(new ApplyStatusEffectsConsumeEffect(java.util.List.of(
                    new MobEffectInstance(MobEffects.INSTANT_HEALTH,1,2, false, false, false),
                    new MobEffectInstance(MobEffects.SPEED, 500, 2, false, false, false)))).sound(SoundEvents.GENERIC_DRINK)
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL)).consumeSeconds(0.5f).build();
    ...
    public static final Consumable SPIDER_CIDER_CONSUMABLE = Consumables.defaultFood()
            .onConsume(new ApplyStatusEffectsConsumeEffect(java.util.List.of(
                    new MobEffectInstance(MobEffects.INSTANT_HEALTH,1,4, false, false, false),
                    new MobEffectInstance(MobEffects.SLOWNESS, 100, 1, false, false, false)))).sound(SoundEvents.HONEY_DRINK)
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL)).consumeSeconds(0.5f).build();
    ...
    public static final Consumable STARFAIT_CONSUMABLE = Consumables.defaultFood()
            .onConsume(new ApplyStatusEffectsConsumeEffect(java.util.List.of(
                    new MobEffectInstance(MobEffects.INSTANT_HEALTH,1,3, false, false, false),
                    new MobEffectInstance(MobEffects.HUNGER, 200, 0, false, false, false)))).sound(SoundEvents.GENERIC_DRINK)
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL)).consumeSeconds(0.5f).build();
    ...
    public static final Consumable STEAK_CONSUMABLE = Consumables.defaultFood()
            .onConsume(new ApplyStatusEffectsConsumeEffect(java.util.List.of(
                    ...
                    new MobEffectInstance(MobEffects.SLOWNESS, 40, 10, false, false, false))))
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL)).consumeSeconds(0.5f).build();
    ...
    public static final Consumable TEMFLAKES_CONSUMABLE = Consumables.defaultFood()
            .onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.INSTANT_HEALTH,1,0, false, false, false)))
            .onConsume(new PlaySoundConsumeEffect(ModSounds.HEAL)).consumeSeconds(0.5f).build();
    ...
    public static final Consumable MAXI_CONSUMABLE = Consumables.defaultFood()
            .onConsume(new ApplyStatusEffectsConsumeEffect(
                    List.of(
                            ...
                            ))).animation(ItemUseAnimation.DRINK).sound(SoundEvents.HONEY_DRINK)
            .onConsume(new PlaySoundConsumeEffect(SoundEvents.MUSIC_DISC_LAVA_CHICKEN)).consumeSeconds(3f).build();
}
